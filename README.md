...
?   ??? client/ # Заголовочные файлы клиента 
?   ?  ??? client.h # Файл класса Client 
?   ??? server/ # Заголовочные файлы сервера 
?   ?  ??? server.h # Файл класса Server 
??? src/ # Исходные файлы (.cpp) 
?   ??? client/ 
?   ?   ??? client.cpp # Реализация класса Client
?   ?   ??? main_client.cpp # Точка входа клиента (main) 
?   ??? server/ # Исходные файлы сервера 
?   ?   ??? server.cpp # Реализация класса Server 
?   ?   ??? main_server.cpp # Точка входа сервера (main)
